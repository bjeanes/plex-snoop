...
Registers PMS with plex.tv and updates list of its known public IPs to advertise connectability.
...
Even though I have users (both home users and sharing) associated with account
